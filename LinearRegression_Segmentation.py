...
X = data[['Total Population',	'Total Households For Period Of Construction Built Before 1961',	'Total Households For Period Of Construction Built Between 1961 And 1980',	'Total Households For Period Of Construction Built Between 1981 And 1900',	'Total Households For Period Of Construction Built Between 1991 And 2000',	'Total Households For Period Of Construction Built Between 2001 And 2005',	'Net New Household (2005 to present)',	'Total Households For Structure Type Houses',	'Total Households For Structure Type Apartment, Building Low And High Rise',	'Total Households For Structure Type Other Dwelling Types',	'Dwellings by Tenure Owner',	'Dwellings by Tenure Renter']]
y = data['Median Household Income (Current Year $)']
...
pred = regressor.predict(data3)

data3['Prediction'] = pred
data3.to_csv(r'C:\Users\saksh\Desktop\Rotman\Fall\Big data analytics\Group Assignment\Last Assignment\LR.csv')
